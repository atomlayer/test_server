...
def add_experience():
    ...
    execute_array([
        ["""update public.ateon_player
                set experience = experience + %s
                where id = %s and user_id =%s""", (experience, player_id, user_id)],
        ["""insert into public.ateon_experience_events (user_id, player_id, experience_value, date)
...
def get_experience():
    ...
    res = select("""select experience from public.ateon_player 
